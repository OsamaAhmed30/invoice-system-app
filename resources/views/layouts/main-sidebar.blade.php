			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('assets/img/photos/27.avif')}}"><span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='paid') }}">الفواتير المدفوعه</a></li>
							@endcan
							<li><a class="slide-item" href="{{ url('/' . $page='partial_paid') }}">الفواتير المدفوعه جزئيا</a></li>
							@can('الفواتير الغير مدفوعة')
							<li><a class="slide-item" href="{{ url('/' . $page='unpaid') }}">الفواتير الغير المدفوعه</a></li>
							@endcan
							@can('ارشيف الفواتير')
